...
##
## - We also adjuest for the fact that GPS data may 
...
Units_for_matching_high_high<-Units_by_locations[which(Units_by_locations$prevalence_pre> 0.5 & Units_by_locations$prevalence_post > 0.5 & abs(Units_by_locations$prevalence_pre- Units_by_locations$prevalence_post)<0.1 ), ]
Units_for_matching_high_low<-Units_by_locations[which(Units_by_locations$prevalence_pre> 0.5 & Units_by_locations$prevalence_post < 0.1), ]

####We discard any clusters with constantly zero prevalence
which(Units_for_matching_high_low$index_2 %in% index_zero) #There is no such cluster
...
write.csv(Units_for_matching, '/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/step1_Units_for_card_match.csv')
...
## purpose.
## 
## - Prevalence > 0.5 or < 0.1 are identify to be High
...
#We then calculate the averages of each covariates
...
#covariate<-read.csv("C:/Users/siyuheng/Desktop/Malaria and Birthweight/Input Data/idhs_00045.csv.gz")
covariate<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Input Data/idhs_00045.csv.gz")
...
sum(covariate$FLOOR>3)/sum(!is.na(covariate$FLOOR))  
sum(covariate$TOILETTYPE>1)/sum(!is.na(covariate$TOILETTYPE)) 
sum(covariate$ELECTRCHH>1)/sum(!is.na(covariate$ELECTRCHH))   

#covariate_edu<-read.csv("C:/Users/siyuheng/Desktop/Malaria and Birthweight/Input Data/idhs_00046.csv.gz")
covariate_edu<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Input Data/idhs_00046.csv.gz")
...
table(covariate_edu$EDUCLVL)
sum(covariate_edu$EDUCLVL>2)/sum(!is.na(covariate_edu$EDUCLVL))   

#covariate_fp<-read.csv("C:/Users/siyuheng/Desktop/Malaria and Birthweight/Input Data/idhs_00048.csv.gz")
covariate_fp<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Input Data/idhs_00048.csv.gz")
...
#covariate_fp$FPTYPNOW[covariate_fp$FPTYPNOW>0]=1
covariate_fp$FPTYPNOW[covariate_fp$FPTYPNOW<20]=0
covariate_fp$FPTYPNOW[covariate_fp$FPTYPNOW==20]=1
table(covariate_fp$FPTYPNOW) # No missing or unspecified data 


write.csv(covariate,file="/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/covariate_household.csv")
write.csv(covariate_edu, file = "/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/covariate_births_edu.csv")
write.csv(covariate_fp, file = "/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/covariate_births_fp.csv")


############run categorize and then run this###########

covariate_household<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/covariate_household.csv")
covariate_births_edu<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/covariate_births_edu.csv")
covariate_births_fp<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/covariate_births_fp.csv")
covariate_children<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Input Data/idhs_00049.csv.gz")
...
write.csv(Units_for_matching, file = "/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/Units_before_cardinality_matching.csv")

#Units_for_matching<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/Units_before_cardinality_matching.csv")
...
write.csv(Units_after_cardinality_matching, file = "/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/Units_after_cardinality_matching.csv")
...
save(subset_index, Units_for_matching, Units_after_cardinality_matching, file = "/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/Units_after_cardinality_matching_with_index.RData")
...
Children_covariates<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Input Data/idhs_00051.csv.gz")

## Load from step2: subset_index, Units_for_matching and Units_after_cardinality_matching
#load(file = "C:/Users/siyuheng/Desktop/Malaria and Birthweight/Output Data SA4/Units_after_cardinality_matching.RData")
...
## The 4 blocks constructed save into individual_matched 
...
#write.csv(individual_matched, "/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/indivisual_matched_before_imputation.csv")

#individual_matched<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/indivisual_matched_before_imputation.csv")
...
Units_after_matching<-read.csv("/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/Units_after_cardinality_matching.csv")
...
## Output the data
write.csv(matrix_table, file ="/Users/heng6/Desktop/Code and Data for Malaria and Low Birth Weight/Output Data SA4/step3_Inference_with_mutiple_imputation.csv")

####Save all the data "all_data_SA4
